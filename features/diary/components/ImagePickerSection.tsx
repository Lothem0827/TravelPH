            ...
            >
                {isProcessing ? (
                    <View className="items-center">
                        ...
                        <AppText variant="BodySmall" className="text-yellow-600 font-medium mt-1">Adding...</AppText>
                    </View>
                ) : (
    ...
    return (
        <View className="flex-col gap-0.5">
            <View className="flex-row items-center justify-between">
                <AppText variant="Label" >Your memories</AppText>
                <AppText variant="Label" >({images.length}/20)</AppText>
            </View>
